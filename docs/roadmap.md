...
- ⬜ `feature/calendar-service` — slot/çakışma kontrolü + müsaitlik yoksa alternatif önerisi. İlk etapta insan-okur bir yanıt yeterli; alternatif bilgisinin yapılandırılmış (düz metne gömülü değil) dönmesi de tasarım aşamasında bir seçenek olarak düşünülebilir (gerekçe aşağıda, "SeekBind 2.0" notunda)
